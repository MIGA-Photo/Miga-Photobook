...
const translations = {
  ar: {
    ...
    aboutUsTitle:'من نحن',
    aboutLead:'مرحباً بك في Miga-Photobook — منصة متخصصة في تحويل الصور العادية إلى صور احترافية عالية الجودة باستخدام أحدث تقنيات ميجا المتطورة.',
    aboutMissionTitle:'رسالتنا',
    aboutMissionIntro:'نسعى إلى جعل الصور الاحترافية متاحة للجميع من خلال:',
    aboutMission1:'جودة عالية',
    aboutMission2:'سرعة في التنفيذ',
    aboutMission3:'أسعار مناسبة',
    aboutMission4:'تجربة استخدام بسيطة',
    aboutMission5:'الحفاظ الكامل على خصوصية العملاء',
    aboutWhyTitle:'لماذا يختارنا العملاء؟',
    aboutWhy1:'نتائج احترافية خلال دقائق',
    aboutWhy2:'أكثر من 50 نمطاً فنياً مختلفاً',
    aboutWhy3:'دعم فني مباشر عبر واتساب ووسائل التواصل على الموقع (تواصل مع ميجا)',
    aboutWhy4:'أسعار مناسبة للسوق المصري',
    aboutWhy5:'خصوصية وأمان للصور المرفوعة',
    aboutFounderTitle:'مؤسس المشروع',
    aboutFounderName:'مجدي فاروق سليمان «ميجا»',
    aboutFounderBio:'صاحب خبرة طويلة في إدارة الأعمال والأنظمة الرقمية، ويعمل على تقديم حلول عملية تعتمد على الذكاء الاصطناعي لتسهيل حياة المستخدمين وتحسين تجربتهم الرقمية.',
    aboutPrivacyTitle:'التزامنا بالخصوصية',
    aboutPrivacyIntro:'نحن ندرك أن الصور الشخصية من أكثر البيانات حساسية، لذلك:',
    aboutPrivacy1:'لا نبيع صورك ولا نستخدمها في أي تسويق؛ ولتنفيذ طلبك فقط، تُرسَل الصورة بأمان إلى مزوّد الذكاء الاصطناعي المتخصص في التحويل.',
    aboutPrivacy2:'لا يتم نشر أي صورة دون موافقة صاحبها.',
    aboutPrivacy3:'يتم التعامل مع جميع الملفات بسرية كاملة.',
    aboutPrivacy4:'يمكن للعميل طلب حذف بياناته في أي وقت.',
    aboutContactTitle:'تواصل معنا',
    aboutContactAddress:'القاهرة، مصر',
    aboutLogoAlt:'شعار Miga-Photobook — ميجا فوتوبوك',
    aboutTagline:'نحن لا نبيع صوراً فقط، بل نساعدك في الحصول على أفضل نسخة من ذكرياتك وصورتك الشخصية.',
    aboutUsText:'بدأت فكرة Miga-Photobook لتوفير صور احترافية بأسعار مناسبة للجميع، دون الحاجة إلى جلسات تصوير مكلفة أو برامج تصميم معقدة. هدفنا مساعدة الأفراد والعائلات ورواد الأعمال على الحصول على صور مميزة خلال دقائق فقط.',
    ...
    faqQ7:'هل أقدر أختار أكثر من ستايل؟', faqA7:'أكيد! تقدر تطلب أكتر من ستايل لنفس الصورة أو لصور مختلفة — كل ستايل بيتحسب طلب منفصل، أو استخدم إحدى الباقات (3 أو 15 أو 30 صورة) عشان توفر لو محتاج أكتر من نتيجة.',
    ...
    payMethodInstapay:'إنستاباي', payMethodVodafone:'فودافون كاش', payMethodCard:'', payMethodFawry:'',
    ...
    transformPrivacyNote:'صورتك تُرسَل بشكل آمن إلى خدمة معالجة الصور لإنشاء النتيجة، ولا تُخزَّن بشكل دائم على خوادمنا.',
  ...
  en: {
    ...
    aboutLead:'Welcome to Miga-Photobook — a platform dedicated to turning ordinary photos into high-quality professional portraits using the latest Miga technology.',
    aboutMissionTitle:'Our mission',
    aboutMissionIntro:'We want professional photography to be within everyone\u2019s reach, through:',
    aboutMission1:'High quality',
    aboutMission2:'Fast turnaround',
    aboutMission3:'Fair pricing',
    aboutMission4:'A simple experience',
    aboutMission5:'Complete customer privacy',
    aboutWhyTitle:'Why customers choose us',
    aboutWhy1:'Professional results in minutes',
    aboutWhy2:'More than 50 different artistic styles',
    aboutWhy3:'Direct support on WhatsApp and through the site (Contact Miga)',
    aboutWhy4:'Pricing suited to the Egyptian market',
    aboutWhy5:'Privacy and security for every uploaded photo',
    aboutFounderTitle:'Founder',
    aboutFounderName:'Magdy Farouk Soliman \u2014 \u201cMiga\u201d',
    aboutFounderBio:'With long experience in business management and digital systems, he builds practical AI-based solutions that make people\u2019s digital lives easier.',
    aboutPrivacyTitle:'Our privacy commitment',
    aboutPrivacyIntro:'We know personal photos are among the most sensitive data there is, so:',
    aboutPrivacy1:'We never sell your photos or use them for unrelated marketing. To fulfill your order, your photo is securely sent to our specialized AI processing provider — for that purpose only.',
    aboutPrivacy2:'No photo is ever published without its owner\u2019s consent.',
    aboutPrivacy3:'Every file is handled in complete confidence.',
    aboutPrivacy4:'You can request deletion of your data at any time.',
    aboutContactTitle:'Contact us',
    aboutContactAddress:'Cairo, Egypt',
    aboutLogoAlt:'Miga-Photobook logo',
    aboutTagline:'We don\u2019t just sell photos — we help you get the best version of your memories and of yourself.',
    aboutUsText:"Miga-Photobook began as a way to make professional photos affordable for everyone, with no costly studio session and no complicated design software. Our goal is to help individuals, families and business owners get a standout photo in minutes.",
    ...
    faqQ7:'Can I choose more than one style?', faqA7:'Of course! You can order more than one style for the same photo or for different photos — each style counts as a separate order, or use one of the bundles (3, 15, or 30 photos) to save if you need more than one result.',
    ...
    payMethodInstapay:'InstaPay', payMethodVodafone:'Vodafone Cash', payMethodCard:'', payMethodFawry:'',
    ...
    transformPrivacyNote:'Your photo is sent securely to an image-processing service to create the result, and is not permanently stored on our servers.',
