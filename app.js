...
const translations = {
  ar: {
    ...
    whyEdgeP2:'أي حد يقدر يفتح أداة ذكاء اصطناعي، لكن النتيجة بتعتمد على الوصف: زاوية الإضاءة، العدسة، درجة اللون. من غير ده بتطلع صورة «مش وحشة» — مش صورة استوديو.',
    whyEdgeP3:'كل صورة في المعرض هنا نتيجة برومبت اتظبط وترجعنا فيه عشرات المرات لحد ما وصل للشكل ده. انت مش بتشتري «تحويل بالذكاء الاصطناعي» — انت بتشتري البرومبت المجرّب والنتيجة اللي شايفها قدامك بالظبط، من أول مرة وبدون تخمين.',
    whyEdgeP4:'وعشان إحنا واثقين في ده، بنبيعلك البرومبت نفسه بـ 10 جنيه لو حابب تشتغل بيه بنفسك. <a href="#children" class="why-edge-link">تصفّح الصور واختار البرومبت ←</a>',
    ...
    heroCta1:'تصفح المكتبة', heroCta2:'الأسعار والعروض',
    ...
    plan2Li1:'وفّر حتى 40% عن السعر الفردي', plan2Li2:'اختيار حر من أي قسم', plan2Li3:'دعم فني بالأولوية',
    ...
    buyModalNote:'هنراجع التحويل تلقائيًا — الصفحة هتفضل فاتحة قدامك وهتقولك أول ما يتأكد، من غير ما تدوّر على كود في مكان تاني.',
  ...
  en: {
    ...
    whyEdgeP2:'Anyone can open an AI tool, but the result depends on the description: the angle of the light, the lens, the colour grade. Without those you get a photo that is “not bad” — not a studio photo.',
    whyEdgeP3:'Every image in this gallery is the result of a prompt we refined dozens of times until it looked like this. You are not buying “an AI transformation” — you are buying the proven prompt and exactly the result you can see, first time, with no guesswork.',
    ...
    heroCta1:'Browse the Library', heroCta2:'Pricing & Offers',
    ...
    plan2Li1:'Save up to 40% off individual price', plan2Li2:'Free choice from any section', plan2Li3:'Priority support',
    ...
    buyModalNote:"We'll review the transfer automatically — this page stays open and updates itself once confirmed, no separate code to look for.",
